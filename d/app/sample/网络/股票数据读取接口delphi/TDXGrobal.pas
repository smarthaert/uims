...
//----------------------------------
   ...
   TRNotifyEvent = procedure of object; stdcall;
   TOnAfterReadEvent        = procedure (msg  :integer) of object; stdcall;
   //TOnDecodePacket    = procedure (Sender: TObject; Const MSG_ID: integer; Const pData: pTTdxData; pDeBuffer: PChar)of object; stdcall;
   TOnDecodePacket_PKDAT    = procedure (data: array of TTDX_PKDAT; StockCount: integer)of object; stdcall;
