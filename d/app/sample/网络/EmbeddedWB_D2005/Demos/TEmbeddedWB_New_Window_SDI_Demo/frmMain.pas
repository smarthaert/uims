...
uses
  ...
  Dialogs, OleCtrls, SHDocVw_EWB, EmbeddedWB, StdCtrls, IEAddress, ExtCtrls;
...
type
  TForm1 = class(TForm)
    ...
    procedure EmbeddedWB1WindowSetResizable(ASender: TObject;
      Resizable: WordBool);
    procedure EmbeddedWB1WindowSetHeight(ASender: TObject; Height: Integer);
    ...
    procedure EmbeddedWB1AddressBar(ASender: TObject; AddressBar: WordBool);
    procedure FormShow(Sender: TObject);
    procedure EmbeddedWB1NewWindow3(ASender: TObject; var ppDisp: IDispatch;
...
procedure TForm1.EmbeddedWB1AddressBar(ASender: TObject; AddressBar: WordBool);
begin
...
procedure TForm1.EmbeddedWB1NewWindow3(ASender: TObject; var ppDisp: IDispatch;
  var Cancel: WordBool; dwFlags: Cardinal; const bstrUrlContext,
  bstrUrl: WideString);
var
   NewApp: TForm1;
...
procedure TForm1.EmbeddedWB1Resize(Sender: TObject; Width, Height: Integer);
begin
      if (WindowState = wsNormal) then
      begin
...
procedure TForm1.EmbeddedWB1Visible(ASender: TObject; Visible: WordBool);
var
   dwClHeight: Integer;
begin
   OutputDebugString(PChar('Visible: ' + SZ_BOOL[Visible]));
   if not m_bCreatedManually {and not m_bFullScreen} then
      begin
         ...
         HandleNeeded;
         if (m_Rect.Right > 0) and (m_Rect.Bottom > 0) then
            begin
               dwClHeight := 0;
...
procedure TForm1.EmbeddedWB1WindowSetHeight(ASender: TObject; Height: Integer);
begin
...
procedure TForm1.EmbeddedWB1WindowSetWidth(ASender: TObject; Width: Integer);
begin
