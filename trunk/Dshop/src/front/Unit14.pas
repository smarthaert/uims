...
procedure TQR.SpeedButton1Click(Sender: TObject);
begin
  QR.Close;
end;

procedure TQR.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
...
procedure TQR.SpeedButton2Click(Sender: TObject);
begin
...
procedure TQR.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then
  begin
    key := #0;
...
procedure TQR.FormShow(Sender: TObject);
begin
  ADOQuery1.Close;
  ADOQuery1.SQL.Clear;
