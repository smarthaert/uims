...
function isStudentTicketDateValid(){
	...
	var winterHolidayEnd=(parseInt(curYear, 10)+1)+"-"+sTicketEndDate[1];
...
function getSelected(selectStr) {
	...
	if (flag) {
		submitRequest(station_train_code,lishi,starttime,trainno,from_station_telecode,to_station_telecode,arrive_time,from_station_name,to_station_name,ypInfoDetail,mmStr);
	}
}
