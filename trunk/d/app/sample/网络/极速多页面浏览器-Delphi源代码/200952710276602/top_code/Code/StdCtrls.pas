...
//dddddddddddddddddddddkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk
  ...
  try
    ...
    begin
      ...
      begin
        ...
        //{
        R.Left := R.Right - GetSystemMetrics(SM_CXHTHUMB) - 1 - 1;
        if DroppedDown then
        ...
        C.FillRect(R);
        {
        C.MoveTo(R.Left + 6, R.Top + 9);
        C.LineTo(R.Left + 9, R.Top + 12);
        C.LineTo(R.Left + 12, R.Top + 9);
        C.LineTo(R.Left + 6, R.Top + 9);
        C.LineTo(R.Left + 10, R.Top + 11);
        C.LineTo(R.Left + 11, R.Top + 10);
        }
        C.MoveTo(R.Left + 6, R.Top + 9);
        C.LineTo(R.Left + 9, R.Top + 12);
        C.LineTo(R.Left + 12, R.Top + 9);
        C.LineTo(R.Left + 7, R.Top + 9);
        C.LineTo(R.Left + 9, R.Top + 11);
        C.LineTo(R.Left + 9, R.Top + 10);
        C.LineTo(R.Left + 12, R.Top + 9);
      end;
    end;
  finally
