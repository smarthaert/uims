//***********************************************************
//            IETravelLog ver 1.00 (Oct 19, 2001)           *
//                                                          *
//                       For Delphi 4 & 5 & 6               *
//                     Freeware Component                   *
//                            by                            *
...
begin
  ...
  begin
    if Failed(EmbeddedWB.Application.QueryInterface(IServiceprovider, ISP)) then exit;
    if Succeeded(ISP.QueryService(SID_STravelLogCursor, IID_ITravelLogStg, Stg)) then Result := TRUE;
  end;
end;
